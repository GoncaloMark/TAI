...
echo " " &&
echo "Duration 10" &&
./bin/MusicIdentifier -q "data/query_segments/Balada_15_10.wav" -m gzip -d music &&
...
echo " " &&
echo "Duration 5" &&
./bin/MusicIdentifier -q "data/query_segments/Balada_15_5.wav" -m gzip -d music &&
...
echo " " &&
echo "Duration 1" &&
./bin/MusicIdentifier -q "data/query_segments/Balada_15_1.wav" -m gzip -d music &&
...
./bin/MusicIdentifier -q "data/query_segments/Balada_15_10_noisy_025.wav" -m gzip -d music &&
...
./bin/MusicIdentifier -q "data/query_segments/Balada_15_5_noisy_025.wav" -m gzip -d music &&
...
./bin/MusicIdentifier -q "data/query_segments/Balada_15_1_noisy_025.wav" -m gzip -d music &&
...
./bin/MusicIdentifier -q "data/query_segments/Balada_15_10_noisy_050.wav" -m gzip -d music &&
...
./bin/MusicIdentifier -q "data/query_segments/Balada_15_5_noisy_050.wav" -m gzip -d music &&
...
./bin/MusicIdentifier -q "data/query_segments/Balada_15_1_noisy_050.wav" -m gzip -d music
